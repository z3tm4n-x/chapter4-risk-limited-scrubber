...
ARTIFACTS = [
    ...
    {
        "key": "vivado_ooc_impl",
        "title": "Vivado out-of-context implementation report",
        "path": "results/vivado_ooc/vivado_ooc_report.md",
        "claim": "Selected Chapter 4 RTL tops close timing in out-of-context implementation on a commercial AMD/Xilinx FPGA demonstrator.",
    },
    {
        "key": "overhead_gain",
